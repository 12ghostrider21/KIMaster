...
class CheckersNNet():
    ...
    def build_simple(self):
        ...
        self.image_stack_size, self.board_x, self.board_y))  # s: batch_size x image_stack_size x board_x x board_y
        ...
        h_conv1 = Activation('relu')(BatchNormalization(axis=3)(
            Conv2D(args.num_channels, 3, data_format="channels_first", padding='same')(
        ...
        h_conv4 = Activation('relu')(BatchNormalization(axis=3)(
            Conv2D(args.num_channels, 3, data_format="channels_first", padding='same')(
                h_conv3)))  # batch_size  x board_x x board_y x num_channels
