...
| play    | valid_moves | None                   | 208             | 153, 250, 251, 252                       | moves, board, shape, type         | Returns a new image from game with highlighted positions of possible moves.                               |
...
| play    | undo_move   | num                    | 209             | 153, 250, 251, 252, 258, 259, 268        | num                               | Undo the last **num** moves.                                                                              |
