...
from api_fixtures import web_socket_uri, max_response_time, create_lobby_msg, join_lobby_msg
...
@pytest.mark.asyncio
async def test_creating_multiple_lobbies(web_socket_uri, create_lobby_msg, join_lobby_msg):
    # connect as player-1 to the server
    async with connect(web_socket_uri) as conn:
        # create first lobby
